...
class ProfilePagemanager extends StatefulWidget {
  ProfilePagemanager({super.key});

  @override
  State<ProfilePagemanager> createState() => _ProfilePagemanagerState();
}

class _ProfilePagemanagerState extends State<ProfilePagemanager> {
  final double _profile_complete_proces = 100;
  // Change this to a value between 0 and 100
  int _gift = 16;
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              const SizedBox(height: 10),
                              Text("₹ ${_profile_complete_proces.toString()}",
                                  style: midheadline),
                            ],
                          ),
                          Column(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: CircularProgressIndicator(
                                      value: _profile_complete_proces / 100.0,
                                      strokeWidth: 3,
                                  ...
                                  Text(
                                    '${_profile_complete_proces.toStringAsFixed(0)}%',
